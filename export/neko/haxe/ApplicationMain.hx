...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("DISCOVERHAXEFLIXEL", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("DISCOVERHAXEFLIXEL", null, 640, 360);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "3";
		app.meta["company"] = "Coneman-Games";
		app.meta["file"] = "DISCOVERHAXEFLIXEL";
